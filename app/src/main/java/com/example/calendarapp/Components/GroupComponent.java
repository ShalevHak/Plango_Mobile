...
public class GroupComponent extends LinearLayout implements IComponent, View.OnClickListener {
    private Group group;

    public GroupComponent(Context context, Group group) {
        super(context);
        this.group = group;
        initComponent(context);
    }

    public GroupComponent(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initComponent(context);
    }

    public GroupComponent(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initComponent(context);
    }

    public GroupComponent(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
